/** @file MaxRectsBinPack.cpp
	...
	[BRS] added allowRotation options.
*/
#include <utility>
#include <iostream>
#include <limits>
...
MaxRectsBinPack::MaxRectsBinPack(int width, int height, bool allowRot )
{
	Init(width, height, allowRot );
}

void MaxRectsBinPack::Init(int width, int height, bool allowRot )
{
	binWidth = width;
	binHeight = height;
